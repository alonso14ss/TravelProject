...
<%
	...
	Cs csObj = (Cs)request.getAttribute("cs");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="registBox">
		<form>
			<label>제목</label> 
			<input type="hidden" name="team" value="<%=csObj.getTeam()%>">
         	<input type="hidden" name="rank" value="<%=csObj.getRank()%>">
         	<input type="hidden" name="depth" value="<%=csObj.getDepth()%>">
