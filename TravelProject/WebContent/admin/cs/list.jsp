		...
		<table>
			...
			<tr>
				...
				<%if(cs.getDepth()>0){ //답변일때만%>
           		re:
            	<%} %>
				<a href="/admin/cs/detail?cs_id=<%=cs.getCs_id()%>"><%=cs.getTitle()%></a>
				</td>
				<td><%=cs.getWriter() %></td>
			...
			<tr>
				<td colspan="4" align="right">
					<button onclick="location.href='/admin/cs/regist'">글 작성</button>
				</td>
			</tr>
			<tr>
		  	<td colspan="6" style="text-align:center">
				...
				<a href="/cs/list?currentPage=<%=i%>">[<%=i%>]</a>  		
				<%}%>
		  	</td>
		  	</tr>
