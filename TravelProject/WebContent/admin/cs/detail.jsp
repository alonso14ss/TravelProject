...
<body>
	...
	<div class="registBox">
		<form>
			...
			<button type="button" onclick="location.href='/admin/cs/list';">목록으로</button>			
			<button type="button" onclick="update()">수정</button>
			<button type="button" onclick="location.href='/admin/cs/del?cs_id=<%=cs.getCs_id()%>';">삭제</button>
