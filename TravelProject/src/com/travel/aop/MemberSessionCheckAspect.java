...
public class MemberSessionCheckAspect {
   public Object sessionCheck(ProceedingJoinPoint joinPoint) throws MemberAuthException,Throwable{
      ...
      if(uri.equals("/") || uri.equals("/product/list") || uri.equals("/detail") ||
            uri.equals("/member/login") || uri.equals("/member/regist") || uri.equals("/searchDestination")
            ||uri.equals("/destination")||uri.equals("/cs/list")||uri.equals("/admin/cs/list")||uri.equals("/admin/cs/detail")
            ||uri.equals("/admin/cs/insert")||uri.equals("/admin/cs/update")||uri.equals("/admin/cs/regist")||uri.equals("/admin/cs/del")
            ||uri.equals("/cs/reply")||uri.equals("/cs/reply/regist"))  {
